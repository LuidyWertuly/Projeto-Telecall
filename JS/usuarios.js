        ...
        $.ajax({
            ...
            success: function (usuarios) {
                ...
                usuarios.forEach(function (usuario) {
                    ...
                    newRow.append('<td>' + '<input class="input-table off campo-nomeMae" id="input-nomeMae" type="text" value="' + usuario.NomeMãe + '" placeholder="Insira os dados" disabled oninput="validateInputText(this)">' + '<i class="fa-solid fa-rotate-left"></i>' + '</td>');
